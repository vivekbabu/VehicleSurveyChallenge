...
public class AbstractTimeAverageDistanceReportTest {
	...
	public void testGenerateReport() {
		...
		averageSpeedForLaneA.put(TimeConstants.MILLIS_PER_HOUR, new Average(TimeConstants.MILLIS_PER_HOUR, 150.0f));
		...
		when(allVehiclesData.getAverageDistance('A', 3600000))
				.thenReturn(averageSpeedForLaneA);
		AbstractTimeAverageDistanceReport abstractTimeAverageDistanceReport = getAbstractTimeAverageDistanceReport();
		abstractTimeAverageDistanceReport.generateAndDisplayReport(allVehiclesData);
		String reportPrinted = log.getLog();
		Assert.assertTrue(reportPrinted.contains("|01:00|150.0|"));
		Assert.assertEquals(23, StringUtils.countMatches(reportPrinted, "|0.0|"));
		
	}
	
	private AbstractTimeAverageDistanceReport getAbstractTimeAverageDistanceReport() {
		return new AbstractTimeAverageDistanceReport(){
