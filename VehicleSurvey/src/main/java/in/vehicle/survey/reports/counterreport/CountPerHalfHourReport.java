...
/**
 * Report for count of vehicles per half hour for all days in each lane
 */
public class CountPerHalfHourReport extends AbstractCountPerTimeReport implements
		VehicleSurveyReport {

	public String getNameOfReport() {
		return ReportConstants.VEHICLE_COUNT_PER_HALF_HOUR;
	}
