...
/**
 * Report for count of vehicles per fifteen minutes for all days in each lane
 */
public class CountPerFifteenMinutesReport extends AbstractCountPerTimeReport implements
		VehicleSurveyReport {

	public String getNameOfReport() {
		return ReportConstants.VEHICLE_COUNT_PER_FIFTEEN_MINUTES;
	}
	...
	public long getTimeFrameOfReport() {
		return TimeConstants.MILLIS_PER_FIFTEEN_MINUTES;
	}
